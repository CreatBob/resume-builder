...
def update_resume_document(document_id: str, payload: ResumeDocumentPayloadDto) -> ResumeDocumentDto:
    settings = resolve_settings()
    repository = build_resume_document_repository(settings)
    return update_resume_document_service(document_id, payload, repository)
